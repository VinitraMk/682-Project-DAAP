...
class PatchAttack(nn.Module):
    ...
    def __init__(self, model, output_dir, patch, translation_range=(0.2, 0.2),
    ...
    def forward(self, img):
       ...
       self.mask_idx = self.__get_mask_indices(patch * mask)
       self.mask_idx = batch * self.mask_idx
